...
public class NewReimbursementRequest {
    ...
    public NewReimbursementRequest(String reim_id, double amount, LocalDate submitted, LocalDate resolved, String description, byte receipt, String payment_id, String author_id, String resolver_id, String status_id, String type_id) {
